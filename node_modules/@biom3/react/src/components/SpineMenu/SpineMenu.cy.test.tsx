...
describe('<SpineMenu />', () => {
  ...
  it('should also render any content that is not a sub-component', () => {
    cyMountWithProviders(
      <SpineMenu>
        <Button testId="button">button will show</Button>
        <div data-testid="hidden">something that will show</div>
        <>testing a fragment</>
    ...
    cy.contains('testing a fragment').should('exist');
