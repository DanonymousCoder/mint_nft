...
declare const dualVariantIcons: {
    readonly Add: null;
    readonly Alert: null;
    readonly AirDrop: null;
    readonly ArrowBackward: null;
    readonly ArrowForward: null;
    readonly Authenticated: null;
    readonly Calendar: null;
    readonly Cart: null;
    readonly ChevronBackward: null;
    readonly ChevronCollapse: null;
    readonly ChevronExpand: null;
    readonly ChevronForward: null;
    readonly CircleRightArrow: null;
    readonly CircleDownArrow: null;
    readonly Close: null;
    readonly CloseWithCircle: null;
    readonly Coins: null;
    readonly CopyText: null;
    readonly Countdown: null;
    readonly Dashboard: null;
    readonly DevContracts: null;
    readonly DevExplorer: null;
    readonly Document: null;
    readonly Documents: null;
    readonly Dollar: null;
    readonly Education: null;
    readonly Edit: null;
    readonly EmailAddress: null;
    readonly EmbedCode: null;
    readonly ESports: null;
    readonly EthToken: null;
    readonly Exclamation: null;
    readonly Expand: null;
    readonly Faucet: null;
    readonly Fullscreen: null;
    readonly FullscreenExit: null;
    readonly Home: null;
    readonly HidePassword: null;
    readonly ImageAdd: null;
    readonly Immutable: null;
    readonly ImxRewards: null;
    readonly ImxToken: null;
    readonly Information: null;
    readonly Instagram: null;
    readonly JumpTo: null;
    readonly Logout: null;
    readonly Lock: null;
    readonly Menu: null;
    readonly Minting: null;
    readonly Minus: null;
    readonly More: null;
    readonly MoreVertical: null;
    readonly Notification: null;
    readonly PancakeSwap: null;
    readonly People: null;
    readonly ReturnKeyboard: null;
    readonly Search: null;
    readonly Security: null;
    readonly SettingsCog: null;
    readonly Shield: null;
    readonly ShowPassword: null;
    readonly SocialShare: null;
    readonly SoundOn: null;
    readonly SoundOff: null;
    readonly Sparkle: null;
    readonly Swatch: null;
    readonly TickWithCircle: null;
    readonly Tags: null;
    readonly Tick: null;
    readonly Tokens: null;
    readonly TreasureChest: null;
    readonly Trophy: null;
    readonly ViewList: null;
    readonly Wallet: null;
    readonly Profile: null;
    readonly Items: null;
    readonly BankCard: null;
};
declare const singleVariantIcons: {
    readonly Apple: null;
    readonly DevSdk: null;
    readonly Discord: null;
    readonly Email: null;
    readonly Exchange: null;
    readonly GraphPerformance: null;
    readonly Google: null;
    readonly InformationCircle: null;
    readonly JumpTo: null;
    ...
    readonly Reddit: null;
    readonly Refresh: null;
    readonly Sort: null;
    readonly SushiSwap: null;
    readonly Swap: null;
    readonly Flip: null;
    readonly Sword: null;
    readonly Telegram: null;
    readonly ThemeDark: null;
    readonly ThemeLight: null;
    readonly Twitter: null;
    readonly UniSwap: null;
    readonly Unity: null;
    readonly ViewGrid: null;
    readonly WalletConnect: null;
    readonly WalletDisconnect: null;
    readonly YouTube: null;
    readonly Overview: null;
};
...
declare const lockupLogos: {
    readonly ImmutableHorizontalLockup: typeof ImmutableHorizontalLockup;
    readonly ImmutableVerticalLockup: typeof ImmutableVerticalLockup;
    readonly PassportHorizontalLockup: typeof PassportHorizontalLockup;
    readonly PassportHorizontalLockupCompact: typeof PassportHorizontalLockupCompact;
    readonly PassportVerticalLockup: typeof PassportVerticalLockup;
    readonly HubHorizontalLockup: typeof HubHorizontalLockup;
    readonly HubHorizontalLockupCompact: typeof HubHorizontalLockupCompact;
    readonly HubVerticalLockup: typeof HubVerticalLockup;
    readonly DocsHorizontalLockup: typeof DocsHorizontalLockup;
    readonly DocsHorizontalLockupCompact: typeof DocsHorizontalLockupCompact;
    readonly DocsVerticalLockup: typeof DocsVerticalLockup;
};
declare const immutableSymbolLogos: {
    readonly ImmutableSymbol: typeof ImmutableSymbol;
    readonly PassportSymbol: typeof PassportSymbol;
    readonly PassportSymbolOutlined: typeof PassportSymbolOutlined;
};
declare const otherSymbolLogos: {
    readonly MetaMaskSymbol: typeof MetaMaskSymbol;
    readonly WalletConnectSymbol: typeof WalletConnectSymbol;
    readonly MagicSymbol: typeof MagicSymbol;
    readonly GameStopSymbol: typeof GameStopSymbol;
};
...
type MenuItemFramedIconProps<RC extends ReactElement | undefined = undefined> = BoxWithRCAndDomProps<RC> & Pick<IconProps<undefined>, 'icon'> & Pick<DualVariantIconProps, 'variant'> & Pick<MenuItemProps<undefined>, 'size'> & {
...
declare function splitApartChildrenAndSubComponents(children: ReactNode, subcomponents: ComponentType<any> | ComponentType<any>[]): {
    subcomponents: ReactNode[];
    otherChildren: ReactNode;
};
